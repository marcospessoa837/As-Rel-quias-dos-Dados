...
-- 10 
insert into medico(nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id, em_atividade) values('marcos pessoa', 45679312, 123456, 'marcospessoa837@gmail.com', 'Especialista', 3, 'Ativo');
insert into endereco(logradouro, cep, bairro, cidade, estado, medico_id, paciente_id) values('R. Dourada', 02820-090, 'cohab Brasilandia', 'São Paulo', 'São Paulo', 11, null);
insert into telefone(ddd, numero, medico_id, paciente_id) values(11, 976477753, 11, null);

select * from medico where nome_medico like '%Marcos%';
